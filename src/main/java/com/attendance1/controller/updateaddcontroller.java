...
import com.attendance1.dao.updatestudentdao;

/**
 * Servlet implementation class updateaddcontroller
 */
@WebServlet("/updateaddcontroller")
public class updateaddcontroller extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public updateaddcontroller() {
        super();
